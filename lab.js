...
let dog = {
  name: `Creed`, color: `Brown`, age: 5, goodBoy: true 
};
...
let favoriteThings = {
  ...
  person: "My wife", 
  book: "Harry Potter", 
  movie: "Star Wars (only the first 6, not the new stupid ones)", 
  holiday: "Christmas"
}; 
...
favoriteThings.book = "Not a huge book fan"; 
